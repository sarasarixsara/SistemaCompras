...
class TCPDF_FONTS
{
	 ...
	 * @public static
	 */
	public static function utf8StrRev($str, &$currentfont,$isunicode = true,$setbom = false,$forcertl = false)
	{
	 ...
	 * @public static
	 */
	public static function utf8StrArrRev($arr, &$currentfont,$isunicode = true,$setbom = false, $forcertl = false,$str = '')
	{
	 ...
	 * @public static
	 */
	public static function utf8Bidi($ta,  &$currentfont,$isunicode = true,$str = '', $forcertl = false)
	{
