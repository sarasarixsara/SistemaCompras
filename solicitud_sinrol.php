 ...
 <select name="pasar_estado" id="pasar_estado" class="selectgris">
	...
	?>
		...
		<table class="bordered" id="tabladetalle"  style="clear:both; padding-bottom:20px; margin-top:30px; min-width:950px; width:100%">
			 ...
			 <thead>
					 <tr>
							<th colspan="20"><div id="footer"><span>Listado detalle </span></div></th>
					 </tr>
					 <tr class="TituloDetalles">
							...
							<th width="15">Cant</th>
							<th width="15">Und</th>
							<th width="110" style="font-size:11px;">Aprobo</th>
							<th>Tipo</th>
							<th>Proveedor</th>
	 ...
	 ?>
		...
		<select name="Estadetalle_<?php echo($row_RsListadoDeta_Requ['CODIGO']); ?>" 
		id="Estadetalle_<?php echo($row_RsListadoDeta_Requ['CODIGO']); ?>" 
		class="chzn-select" onchange="PasaEstadoDetalle('<?php echo($row_RsListadoDeta_Requ['CODIGO']); ?>',this.value)">				
		  ...
		  <div class="actiondetalle">
				...
				?>
						<input type="checkbox" 
							...
							<br>
			<?php		 
				 echo('<div class="infodetest" style="padding:10px 20px;" >**Menor Cuantia**</div>');
			...
			<a id="afirmarRect_<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>" href="javascript: FirmaRector('<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>');">Firmar</a>
					...
					echo($row_RsListadoDeta_Requ['APROBADO_DES']);
        ...
        <td width="70">
		<input type="text" name="inpcantidad_<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>" id="inpcantidad_<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>" value="<?php echo($row_RsListadoDeta_Requ['CANTIDAD']); ?>" size="4">
		
		<input type="hidden" name="inpcantidadcopia_<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>" id="inpcantidadcopia_<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>" value="<?php echo($row_RsListadoDeta_Requ['CANTIDAD']); ?>" size="4">
		
		&nbsp;<!--<img onclick="FmodificarCantidad('<?php echo($row_RsListadoDeta_Requ['CODIGO']);?>');" src="imagenes/guardar.png" width="15" height="15">--> <?php   echo($row_RsListadoDeta_Requ['CANTIDAD']); ?></td>
