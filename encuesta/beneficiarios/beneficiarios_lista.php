...
$startRow_RsBeneficiarios = $pageNum_RsBeneficiarios * $maxRows_RsBeneficiarios;
	...
	*/
if($nombre!= ''){
	$query_RsBeneficiarios = $query_RsBeneficiarios." AND B.BENENOMB LIKE '%".$nombre."%'";
}
...
if($totalRows_RsBeneficiarios>0){
	...
	if($pageNum_RsBeneficiarios>0){
		//$primero = sprintf("%spageNum_RsBeneficiarios=%d%s", $currentPage, 0, $queryString_RsBeneficiarios);
		$primero = '0';
		$anterior = sprintf("%spageNum_RsBeneficiarios=%d%s", $currentPage, max(0, $pageNum_RsBeneficiarios - 1), $queryString_RsBeneficiarios);
		$antpage = max(0, $pageNum_RsBeneficiarios - 1);
	}
	if ($pageNum_RsBeneficiarios < $totalPages_RsBeneficiarios) {
	    $siguiente = sprintf("%spageNum_RsBeneficiarios=%d%s", $currentPage, min($totalPages_RsBeneficiarios, $pageNum_RsBeneficiarios + 1), $queryString_RsBeneficiarios);
		$sigpag = min($totalPages_RsBeneficiarios, $pageNum_RsBeneficiarios + 1);
		$ultimo =  sprintf("%spageNum_RsBeneficiarios=%d%s", $currentPage, $totalPages_RsBeneficiarios, $queryString_RsBeneficiarios);
	}
	$paginas = array();
