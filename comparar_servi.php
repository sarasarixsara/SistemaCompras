...
?>
 ...
 <?php
  ...
  ?>
   ...
   <td><?php echo '$'.(number_format($arraycompdetalle[$i]['VALOR_C'],0,'.',','));?></td> 
   <td><?php echo '$'.(number_format($arraycompdetalle[$i]['TOTAL'],0,'.',','));?></td> 
  <?php
  }
  ?>
</tr>
...
<tr>
  ...
  for($i=0; $i<count($arraycompdetalle); $i++){
  ?>
  <td colspan="3" class="Titulo6">CARACTERISTICAS DEL SERVICIO</td>
   <td class="SBRA3"> 
         <?php if($_SESSION['MM_RolID'] == 2 || $_SESSION['MM_RolID'] == 3){ ?>
           <span>
...
<tr>
  ...
  <td colspan="3" class="Titulo6">VALOR TOTAL</td>
   <td class="SBRA3"><?php echo '$'.(number_format($arraycompdetalle[$i]['TOTAL'],0,'.',','));?></td>
  <?php
  } 
  ?>
</tr>
